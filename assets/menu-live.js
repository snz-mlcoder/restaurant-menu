// Patches this category page with live prices/items from Supabase.
// If anything here fails (offline, misconfigured keys, etc.) it fails
// silently and the page just keeps showing whatever was baked into the
// HTML at last deploy -- the static markup is always a safe fallback.
(function () {
  ...
  fetch(endpoint, {
    ...
    .catch(function () {
      // Silent on purpose -- static HTML fallback is already showing.
    });
