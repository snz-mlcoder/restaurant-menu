      ...
      items: [
        {
          ...
          sizes: [
            { id: "drinks-beers-draft-small", label: { en: "Small (20cl)", it: "Piccola (20cl)", es: "Pequeña (20cl)", fr: "Petite (20cl)", de: "Klein (20cl)", zh: "小杯 (20cl)" }, price: "€4.00" },
            { id: "drinks-beers-draft-medium", label: { en: "Medium (40cl)", it: "Media (40cl)", es: "Mediana (40cl)", fr: "Moyenne (40cl)", de: "Mittel (40cl)", zh: "中杯 (40cl)" }, price: "€7.00" },
            { id: "drinks-beers-draft-large", label: { en: "Large (100cl)", it: "Grande (100cl)", es: "Grande (100cl)", fr: "Grande (100cl)", de: "Groß (100cl)", zh: "大杯 (100cl)" }, price: "€15.00" },
          ],
        },
      ...
      subgroups: [
        {
          ...
          items: [
            { name: { en: "Pinot Grigio / Chardonnay / Soave / Sauvignon / Lugana", it: "Pinot Grigio / Chardonnay / Soave / Sauvignon / Lugana", es: "Pinot Grigio / Chardonnay / Soave / Sauvignon / Lugana", fr: "Pinot Grigio / Chardonnay / Soave / Sauvignon / Lugana", de: "Pinot Grigio / Chardonnay / Soave / Sauvignon / Lugana", zh: "灰皮诺 / 霞多丽 / Soave / 长相思 / Lugana" }, sizes: [{ id: "drinks-wine-white-1-glass", label: { en: "Glass", it: "Calice", es: "Copa", fr: "Verre", de: "Glas", zh: "杯" }, price: "€4.50" }, { id: "drinks-wine-white-1-bottle", label: { en: "Bottle", it: "Bottiglia", es: "Botella", fr: "Bouteille", de: "Flasche", zh: "瓶" }, price: "€25.00" }] },
            { name: { en: "Vermentino IGP Salento", it: "Vermentino IGP Salento", es: "Vermentino IGP Salento", fr: "Vermentino IGP Salento", de: "Vermentino IGP Salento", zh: "Vermentino IGP Salento" }, sizes: [{ id: "drinks-wine-white-2-glass", label: { en: "Glass", it: "Calice", es: "Copa", fr: "Verre", de: "Glas", zh: "杯" }, price: "€6.00" }, { id: "drinks-wine-white-2-bottle", label: { en: "Bottle", it: "Bottiglia", es: "Botella", fr: "Bouteille", de: "Flasche", zh: "瓶" }, price: "€28.00" }] },
          ],
        },
        {
          id: "wine-list-red",
          ...
          items: [
            { name: { en: "Cabernet Franc / Cabernet Sauvignon / Chianti DOCG", it: "Cabernet Franc / Cabernet Sauvignon / Chianti DOCG", es: "Cabernet Franc / Cabernet Sauvignon / Chianti DOCG", fr: "Cabernet Franc / Cabernet Sauvignon / Chianti DOCG", de: "Cabernet Franc / Cabernet Sauvignon / Chianti DOCG", zh: "品丽珠 / 赤霞珠 / 基安蒂 DOCG" }, sizes: [{ id: "drinks-wine-red-1-glass", label: { en: "Glass", it: "Calice", es: "Copa", fr: "Verre", de: "Glas", zh: "杯" }, price: "€4.50 - €5.00" }, { id: "drinks-wine-red-1-bottle", label: { en: "Bottle", it: "Bottiglia", es: "Botella", fr: "Bouteille", de: "Flasche", zh: "瓶" }, price: "€25.00" }] },
            { name: { en: "Valpolicella Ripasso", it: "Valpolicella Ripasso", es: "Valpolicella Ripasso", fr: "Valpolicella Ripasso", de: "Valpolicella Ripasso", zh: "Valpolicella Ripasso" }, sizes: [{ id: "drinks-wine-red-2-glass", label: { en: "Glass", it: "Calice", es: "Copa", fr: "Verre", de: "Glas", zh: "杯" }, price: "€6.00" }, { id: "drinks-wine-red-2-bottle", label: { en: "Bottle", it: "Bottiglia", es: "Botella", fr: "Bouteille", de: "Flasche", zh: "瓶" }, price: "€27.00" }] },
          ],
        },
        {
          id: "wine-list-rose-sparkling",
          ...
          items: [
            { name: { en: "Rosato / Prosecco DOC / Moscato", it: "Rosato / Prosecco DOC / Moscato", es: "Rosato / Prosecco DOC / Moscato", fr: "Rosato / Prosecco DOC / Moscato", de: "Rosato / Prosecco DOC / Moscato", zh: "桃红 / DOC 普罗塞克 / 麝香葡萄酒" }, sizes: [{ id: "drinks-wine-rose-1-glass", label: { en: "Glass", it: "Calice", es: "Copa", fr: "Verre", de: "Glas", zh: "杯" }, price: "€4.50" }, { id: "drinks-wine-rose-1-bottle", label: { en: "Bottle", it: "Bottiglia", es: "Botella", fr: "Bouteille", de: "Flasche", zh: "瓶" }, price: "€25.00" }] },
            { name: { en: "Prosecco Superiore di Valdobbiadene DOCG", it: "Prosecco Superiore di Valdobbiadene DOCG", es: "Prosecco Superiore di Valdobbiadene DOCG", fr: "Prosecco Superiore di Valdobbiadene DOCG", de: "Prosecco Superiore di Valdobbiadene DOCG", zh: "瓦尔多比亚德内高级普罗塞克 DOCG" }, sizes: [{ id: "drinks-wine-rose-2-glass", label: { en: "Glass", it: "Calice", es: "Copa", fr: "Verre", de: "Glas", zh: "杯" }, price: "€5.00" }, { id: "drinks-wine-rose-2-bottle", label: { en: "Bottle", it: "Bottiglia", es: "Botella", fr: "Bouteille", de: "Flasche", zh: "瓶" }, price: "€28.00" }] },
          ],
        },
      ],
    },
...
"foods": {
  ...
  categories: [
    ...
    },
    {
      ...
      flatItems: [
        { label: { en: "N.1:", it: "N.1:", es: "N.1:", fr: "N.1 :", de: "N.1:", zh: "N.1：" }, text: { en: "Grilled vegetables and fontina cheese", it: "Verdure grigliate e fontina", es: "Verduras a la parrilla y queso fontina", fr: "Légumes grillés et fontina", de: "Gegrilltes Gemüse und Fontina-Käse", zh: "烤蔬菜和芳提娜芝士" }, allergens: [1, 6, 7, 9] },
        { label: { en: "N.2:", it: "N.2:", es: "N.2:", fr: "N.2 :", de: "N.2:", zh: "N.2：" }, text: { en: "Courgettes (zucchini), ham, and brie", it: "Zucchine, cotto e brie", es: "Calabacín, jamón cocido y brie", fr: "Courgettes, jambon cuit et brie", de: "Zucchini, gekochter Schinken und Brie", zh: "西葫芦、熟火腿和布里芝士" }, allergens: [1, 6, 7, 9] },
        { label: { en: "N.3:", it: "N.3:", es: "N.3:", fr: "N.3 :", de: "N.3:", zh: "N.3：" }, text: { en: "Parma ham, rocket, and tomato", it: "Crudo, rucola e pomodoro", es: "Jamón de Parma, rúcula y tomate", fr: "Jambon de Parme, roquette et tomate", de: "Parmaschinken, Rucola und Tomate", zh: "帕尔马火腿、芝麻菜和番茄" }, allergens: [1, 6, 9] },
        { label: { en: "N.4:", it: "N.4:", es: "N.4:", fr: "N.4 :", de: "N.4:", zh: "N.4：" }, text: { en: "Parma ham", it: "Prosciutto crudo", es: "Jamón de Parma", fr: "Jambon de Parme", de: "Parmaschinken", zh: "帕尔马火腿" }, allergens: [1, 6, 9] },
        { label: { en: "N.5:", it: "N.5:", es: "N.5:", fr: "N.5 :", de: "N.5:", zh: "N.5：" }, text: { en: "Pork, aubergine, and brie cheese", it: "Porchetta, melanzane e brie", es: "Cerdo asado, berenjena y brie", fr: "Porc rôti, aubergine et brie", de: "Gebratenes Schweinefleisch, Aubergine und Brie", zh: "烤猪肉、茄子和布里芝士" }, allergens: [1, 6, 7, 9] },
        { label: { en: "Diavoletta:", it: "Diavoletta:", es: "Diavoletta:", fr: "Diavoletta :", de: "Diavoletta:", zh: "Diavoletta：" }, text: { en: "Spicy salami, chili, and grilled peppers", it: "Salame piccante, peperoncino e peperoni", es: "Salami picante, chile y pimientos asados", fr: "Salami piquant, piment et poivrons grillés", de: "Scharfe Salami, Chili und gegrillte Paprika", zh: "辣萨拉米、辣椒和烤甜椒" }, allergens: [1, 6, 7, 9] },
      ],
    },
    {
      id: "gourmet-burgers",
      ...
      items: [
        { id: "foods-gourmet-burgers-1", name: { en: "Classico", it: "Classico", es: "Classico", fr: "Classico", de: "Classico", zh: "Classico" }, desc: { en: "Beef patty and lettuce", it: "Hamburger di manzo e lattuga", es: "Carne de res y lechuga", fr: "Steak haché de bœuf et laitue", de: "Rinderpatty und Salat", zh: "牛肉饼和生菜" }, price: "€7.00", allergens: [1, 3, 6, 7, 9, 11, 12] },
        { id: "foods-gourmet-burgers-2", name: { en: "Cheeseburger", it: "Cheeseburger", es: "Cheeseburger", fr: "Cheeseburger", de: "Cheeseburger", zh: "芝士汉堡" }, desc: { en: "Beef patty and cheese", it: "Hamburger di manzo e formaggio", es: "Carne de res y queso", fr: "Steak haché de bœuf et fromage", de: "Rinderpatty und Käse", zh: "牛肉饼和芝士" }, price: "€8.00", allergens: [1, 3, 6, 7, 9, 11, 12] },
        { id: "foods-gourmet-burgers-3", name: { en: "Kingburger", it: "Kingburger", es: "Kingburger", fr: "Kingburger", de: "Kingburger", zh: "Kingburger" }, desc: { en: "Beef patty, cheese, pancetta, lettuce, and tomato", it: "Hamburger di manzo, formaggio, pancetta, lattuga e pomodoro", es: "Carne de res, queso, panceta, lechuga y tomate", fr: "Steak haché, fromage, pancetta, laitue et tomate", de: "Rinderpatty, Käse, Pancetta, Salat und Tomate", zh: "牛肉饼、芝士、培根、生菜和番茄" }, price: "€9.00", allergens: [1, 3, 6, 7, 9, 11, 12] },
        { id: "foods-gourmet-burgers-4", name: { en: "Energetico", it: "Energetico", es: "Energetico", fr: "Energetico", de: "Energetico", zh: "Energetico" }, desc: { en: "Chicken cutlet, tomato, cheese, and lettuce", it: "Cotoletta di pollo, pomodoro, formaggio e lattuga", es: "Milanesa de pollo, tomate, queso y lechuga", fr: "Escalope de poulet, tomate, fromage et laitue", de: "Hähnchenschnitzel, Tomate, Käse und Salat", zh: "鸡排、番茄、芝士和生菜" }, price: "€8.50", allergens: [1, 3, 5, 6, 7, 9, 11, 12] },
      ],
    },
    {
      id: "pizzas",
    ...
    },
    {
      ...
      items: [
        { id: "foods-hot-pasta-1", name: { en: "Baked Lasagna", it: "Lasagne al Forno", es: "Lasaña al Horno", fr: "Lasagnes au Four", de: "Lasagne aus dem Ofen", zh: "烤千层面" }, price: "€10.00", allergens: [1, 3, 6, 7, 8, 9] },
        { id: "foods-hot-pasta-2", name: { en: "Vegetarian Lasagna", it: "Lasagne Vegetariane", es: "Lasaña Vegetariana", fr: "Lasagnes Végétariennes", de: "Vegetarische Lasagne", zh: "素食千层面" }, price: "€10.00", allergens: [1, 3, 6, 7, 8, 9] },
        { id: "foods-hot-pasta-3", name: { en: "Spaghetti Carbonara", it: "Spaghetti Carbonara", es: "Espagueti a la Carbonara", fr: "Spaghetti Carbonara", de: "Spaghetti Carbonara", zh: "培根蛋酱意面" }, price: "€12.00", allergens: [1, 3, 6, 7, 8, 9] },
        { id: "foods-hot-pasta-4", name: { en: "Spaghetti with Tomato Sauce", it: "Spaghetti al Pomodoro", es: "Espagueti con Salsa de Tomate", fr: "Spaghetti Sauce Tomate", de: "Spaghetti mit Tomatensauce", zh: "番茄酱意面" }, price: "€10.00", allergens: [1, 3, 6, 8, 9] },
        { id: "foods-hot-pasta-5", name: { en: "Ravioli with Tomato & Basil", it: "Ravioli al Pomodoro e Basilico", es: "Ravioles con Tomate y Albahaca", fr: "Ravioles Tomate et Basilic", de: "Ravioli mit Tomate & Basilikum", zh: "番茄罗勒饺子" }, price: "€12.00", allergens: [1, 3, 6, 7, 8, 9] },
      ],
    },
    {
      id: "fresh-salads",
...
"snacks": {
  ...
  categories: [
    ...
    },
    {
      ...
      allergens: [1, 2, 3, 4, 5, 6, 7, 9, 11, 12],
      flatItems: [
